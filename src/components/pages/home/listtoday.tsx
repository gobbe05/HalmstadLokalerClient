            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="max-w-xl">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
                  Annonsera din lokal <span className="text-primary">idag</span>
                </h1>
                ...
                <div className="grid grid-cols-2 gap-8 mt-12 p-6 rounded-2xl bg-white/80 backdrop-blur shadow-sm border border-gray-100">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Aktiva sökande</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-primary">24h</p>
                    <p className="text-sm text-gray-600 mt-1">Genomsnittlig svarstid</p>
                  </div>
                </div>
