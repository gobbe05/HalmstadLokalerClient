...
const FirstRegisterStage = ({setEmail, errors, setUsername, setPassword, setConfirmPassword, accountType, setAccountType}: FirstRegisterStageProps) => {
  return (
    <>
      <div>
          <label className="font-semibold text-neutral">Email</label>
          <input
          type="email"
      ...
      <div>
        <label className="font-semibold text-neutral">Användarnamn</label>
        <input
          type="text"
      ...
      <div>
        <label className="font-semibold text-neutral">Lösenord</label>
        <input
          type="password"
      ...
      <div>
        <label className="font-semibold text-neutral">Bekräfta Lösenord</label>
        <input
          type="password"
